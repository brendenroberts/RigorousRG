// This file originally written by Miles, itensor/eigensolver.h
// But hacked up by Brenden Roberts to diagonalize ITensors
// TODO: this was quick to do, but sucks. instead, write a thin
// class extending ITensor that implements product, size, and
// use the Davidson that comes with ITensor
//
#ifndef DAVIDSON2_H
#define DAVIDSON2_H
...
davidson2(BigMatrixT const& A, 
         ...
         Args const& args)
    {
    auto maxiter_ = args.getInt("MaxIter",20);
